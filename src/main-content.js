...
export function showProject(project) {
    ...
    const projectFieldObj = projectsArray.find(obj => obj.title === project.title);
   ...
   // Deadline input
    ...
    form.addEventListener('submit', (e) => {
        ...
        if(proj!=='singletask'){
            ...
            const projectIndex = projects.indexOf(projObj);
            ...
            projects[projectIndex] = projObjHyd;
...
function createTasksTable(){
    ...
    // Add header cells
    ['Title', 'Description', 'Deadline','Priority' ,'Status'].forEach(headerText => {
